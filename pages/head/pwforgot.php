...
else if (isset($_GET['a']) && $_GET['a'] == 'mail')
{
	if (isset($_POST['email']))
	{
		...
		if ($result && $result->num_rows > 0)
		{
			...
			$content = '
					Jemand hat eine Änderung des Passworts für deinen Account <b>' . $row['login'] . '</b> beantragt.<br/>
					Wenn du das Passwort wirklich ändern willst, dann folge dem folgenden Link.<br/>
					<br/>
