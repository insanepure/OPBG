...
if($item->IsEquipped() || !$slotItem->IsEquipped() || $item->GetSlot() != $slotItem->GetSlot())
{
  exit();
}
?>
...
<table width="100%" cellspacing="0">
  ...
  <td></td>
    <td align="center" class="borderL borderR">
      ...
      <div class="spacer"></div>
      <img class="boxSchatten borderT borderR borderL borderB" src="img/items/<?php echo $slotItem->GetImage(); ?>.png" style="width:80px;height:80px;">
    ...
    <td align="center" class="borderL borderR">
      ...
      <div class="spacer"></div>
      <img class="boxSchatten borderT borderR borderL borderB" src="img/items/<?php echo $item->GetImage(); ?>.png" style="width:80px;height:80px;">
