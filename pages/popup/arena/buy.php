...
Preis: <b> <span id="price"><?= number_format($item->GetArenaPoints(), '0', '', '.') ?></span> Kolosseumspunkte</b>
<hr>
<div class="spacer"></div>
<?php
...
<form method="POST" action="?p=arena&a=buy">
	...
	Anzahl: <select style="width:100px" class="select" name="amount" onchange="setAmount(this,<?=$item->GetArenaPoints();?>)">
	<?php
	$j = 1;
	$amount = 99;
	while ($j <= $amount)
