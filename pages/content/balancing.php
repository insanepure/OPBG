...
if (isset($_GET['a']) && $_GET['a'] == 'fight')
{
    ...
    for ($f = 0; $f < $fights; ++$f)
    {
        $createdFight = Fight::CreateFight(null, $database, $type, $name, $mode, 0, $actionManager, $berry, $pvp, $gold, $items, 0, 0, 0, $survivalteam, $survivalrounds, $survivalwinner);
        for ($i = 0; $i < $amount1; ++$i)
        {
            $npc1->SetID($i);
        ...
        <table width="90%" cellspacing="0" class="borderT borderL borderR borderB">
            ...
            <tr>
                <td align="right" class="borderR">
                    LP: <input type="text" name="lp1" value="<?php if (isset($_POST['lp1'])) echo $_POST['lp1'];
                    else echo $default * 10; ?>"><br />
                    AD: <input type="text" name="kp1" value="<?php if (isset($_POST['kp1'])) echo $_POST['kp1'];
                    else echo $default * 10; ?>"><br />
                    Attack: <input type="text" name="attack1" value="<?php if (isset($_POST['attack1'])) echo $_POST['attack1'];
                    else echo $default; ?>"><br />
                    Defense: <input type="text" name="defense1" value="<?php if (isset($_POST['defense1'])) echo $_POST['defense1'];
                    else echo $default; ?>"><br />

                    <select class="select" name="race1">
                        <option value="">Keine</option>
                        <option value="Pirat" <?php if (isset($_POST['race1']) && $_POST['race1'] == 'Pirat') echo 'selected'; ?>>Pirat</option>
                        <option value="Marine" <?php if (isset($_POST['race1']) && $_POST['race1'] == 'Marine') echo 'selected'; ?>>Marine</option>
                    </select>
                ...
                <td align="right">
                    LP: <input type="text" name="lp2" value="<?php if (isset($_POST['lp2'])) echo $_POST['lp2'];
                    else echo $default * 10; ?>"><br />
                    AD: <input type="text" name="kp2" value="<?php if (isset($_POST['kp2'])) echo $_POST['kp2'];
                    else echo $default * 10; ?>"><br />
                    Attack: <input type="text" name="attack2" value="<?php if (isset($_POST['attack2'])) echo $_POST['attack2'];
                    else echo $default; ?>"><br />
                    Defense: <input type="text" name="defense2" value="<?php if (isset($_POST['defense2'])) echo $_POST['defense2'];
                    else echo $default; ?>"><br />
                    <select class="select" name="race2">
                        <option value="">Keine</option>
                        <option value="Pirat" <?php if (isset($_POST['race2']) && $_POST['race2'] == 'Pirat') echo 'selected'; ?>>Pirat</option>
                        <option value="Marine" <?php if (isset($_POST['race2']) && $_POST['race2'] == 'Marine') echo 'selected'; ?>>Marine</option>
                    </select>
            ...
            <tr>
                <td align="center" class="borderR">
                    ...
                    while ($entry != null)
                    {
                        ...
                        <div style="height:60px; width:40px; display: inline-block;">
                            <img width="40px" height="40px" src="img/attacks/<?php echo $entry['image']; ?>.png" alt="<?php echo $entry['name']; ?>" title="<?php echo $entry['name']; ?>" class="attack"> <input type="checkbox" name="attacks1[]" value="<?php echo $entry['id']; ?>" <?php if (isset($_POST['attacks1']) && in_array($entry['id'], $_POST['attacks1']))  echo 'checked'; ?>>
                        </div>
                        <?php
                        ++$id;
                        $entry = $attacks->GetEntry($id);
                ...
                <td align="center">
                    ...
                    while ($entry != null)
                    {
                        ?>
                        <div style="height:60px; width:40px; display: inline-block;">
                            <img width="40px" height="40px" src="img/attacks/<?php echo $entry['image']; ?>.png" alt="<?php echo $entry['name']; ?>" title="<?php echo $entry['name']; ?>" class="attack"> <input type="checkbox" name="attacks2[]" value="<?php echo $entry['id']; ?>" <?php if (isset($_POST['attacks2']) && in_array($entry['id'], $_POST['attacks2'])) echo 'checked'; ?>>
                        </div>
                        <?php
                        ++$id;
                        $entry = $attacks->GetEntry($id);
            ...
            <tr>
                <td colspan="2" align="center" class="borderT" height="40px">
                    Runden: <input type="text" name="rounds" value="<?php if (isset($_POST['rounds'])) echo $_POST['rounds'];
                    else echo $defaultRounds; ?>"><br />
                    Fights: <input type="text" name="fights" value="<?php if (isset($_POST['fights'])) echo $_POST['fights'];
                    else echo $defaultFights; ?>"><br />
    ...
    <table width="90%" cellspacing="0" class="borderT borderL borderR borderB">
        ...
        <tr>
            <td align="left" class="borderR">
                ...
                AD: <?php echo $resultKP1 . '/' . $resultMKP1; ?><br />
            ...
            <td align="left">
                ...
                AD: <?php echo $resultKP2 . '/' . $resultMKP2; ?><br />
