...
if (!isset($_GET['p2']) || $_GET['p2'] == 'inbox')
{
    ...
    <form method="POST" action="?p=pm2<?php if (isset($_GET['page'])) echo '&page=' . $_GET['page']; ?>&a=action">
        <table width="98%" cellspacing="0" border="0">
            ...
            <?php
            $PMManager->LoadInbox($start, $limit, true, $player->IsAdminLogged(), false);
            $i = 0;
    ...
    <br />
    <button onclick="OpenPopupPage('Alle Nachrichten löschen','pm/manage.php?a=deleteall&p=2')">
