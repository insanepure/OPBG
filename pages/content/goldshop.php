<img width='100%' height='300' src='img/marketing/Premium.png' />
<table width="100%" cellspacing="0" border="0" style="margin-top: -5px;">
    ...
    <tr>
        <form method="GET" action="?p=goldshop">
            <input type="hidden" name="p" value="goldshop">
            <td width="40%">
...
<table width="100%" cellspacing="0" border="0">
    ...
    <tr>
        <td colspan=6 class="catGradient borderT borderB" align="center">
            <b>
        <span style="color: white">
          <div class="schatten">Gold-Shop</div>
        </span>
            </b>
        </td>
    </tr>
    ...
    <?php
        ...
        while (isset($items[$i]))
        {
            ...
            if(in_array($item->GetID(), $shipArray) && ($player->GetRace() == "Marine" && !in_array($item->GetID(), $marineShipArray) || $player->GetRace() == "Pirat" && !in_array($item->GetID(), $pirateShipArray)))
            {
                $i++;
                continue;
            }
            ...
            <tr>
                ...
                <td class="borderT" class="boxSchatten" align="center">
                ...
                <td class="borderT">
                    <button onclick="OpenPopupPage('Item Kaufen','shop/goldbuy.php', 'item=<?php echo $item->GetID();
