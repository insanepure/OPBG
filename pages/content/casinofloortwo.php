...
{
    $casinoitemeins = array("31", "32", "33", "34", "81", "82", "83", "84", "86", "87", "103", "104", "317", "135", "136");
    $casinoitemzwei = array("31", "32", "33", "34", "81", "82", "83", "84", "86", "87", "103", "104", "317", "135", "136");
    $casinoitemdrei = array("31", "32", "33", "34", "81", "82", "83", "84", "86", "87", "103", "104", "317", "135", "136");
    $casinoitemvier = array("31", "32", "33", "34", "81", "82", "83", "84", "86", "87", "103", "104", "317", "135", "136");
    $casinoitemfünf = array("31", "32", "33", "34", "81", "82", "83", "84", "86", "87", "103", "104", "317", "135", "136");
    ...
    echo "<form method='POST' action='?p=casinofloortwo&dice=roll'><button value='Würfeln'>Würfeln</button></form><br /><br />";
    ?>
    <style>
        .casino_bild{
            position:absolute;
    ...
    echo "<a href='?p=casinofloortwo&dice=roll'><img height='640' width='440' src='".$serverUrl."img/marketing/Casino3.png' /></a><br /><br />";
    echo "</div>";
    ...
    <fieldset>
        ...
        <table><tr><td>
                    ...
                    <b><font color='0066FF'>1. </font></b></td><td>Sobald du auf den Hebel klickst, kostet es dich <?php echo (date("w") == 4) ? ("<s>5.000</s> ") . ("nur heute: ". number_format($cost, 0, ".", ".")) : ("5.000") ?><img width='15' height='15' src='<?php echo $serverUrl; ?>img/offtopic/BerrySymbol.png' /></td></tr><tr><td>
                    ...
                    <b><font color='0066FF'>10.</font></b></td><td>Bereits getätigte Ausgaben: <?= number_format($player->GetCasinoOutOfMoney(),0,'', '.') ?><img width='15' height='15' src='<?php echo $serverUrl; ?>img/offtopic/BerrySymbol.png' /></td></tr><tr><td>
                    <b><font color='0066FF'>11.</font></b></td><td>Aktiver Rabatt: <?= $player->GetRabatt() ?>%</td></tr><tr><td>
                    <b><font color='0066FF'>12.</font></b></td><td>Die letzte Ziehung hat dich <?= number_format($prices,0,'', '.') ?><img width='15' height='15' src='<?php echo $serverUrl; ?>img/offtopic/BerrySymbol.png' /> gekostet!</td></tr><tr><td>
                </td></tr>
        </table>
    </fieldset>
    <?php
